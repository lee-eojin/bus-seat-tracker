...
import { observationsByVehicle, type VehicleObservation } from '../../../packages/domain/src/profile.js';
import { expectedSnapshotGapSeconds, serviceElapsedMs } from '../../../tools/collector/src/schedule.js';
